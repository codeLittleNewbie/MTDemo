...
export default class Food extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            dataSource : ds.cloneWithRows(this.props.foodItem.nearbeans),
            topLables : this.props.foodItem.topLables,
            activeIndex : 0,
        }
    }
    ...
    render(){
        ...
        // 判断是否获取到数据
        if (this.props.foodItem.nearbeans == undefined){
        ...
        // // 替换状态机
        // this.state = {
        //     dataSource : this.state.dataSource.cloneWithRows(this.props.foodItem.nearbeans),
        //     topLables : this.props.foodItem.topLables,
        // };

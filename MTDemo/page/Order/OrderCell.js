...
export default class All extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            dataSource : ds.cloneWithRows(this.props.allItem),
            activeIndex : 0,
        }
    }
    ...
    render(){
        ...
        // 判断是否获取到数据
        if (this.props.allItem == undefined){

            return(<View></View>);
        }

        this.state = {
            dataSource : this.state.dataSource.cloneWithRows(this.props.allItem),
            activeIndex : 0,
        };
